...
#ifdef GPU
__global__ void update_pagerank(int *ingoing_edges_num, int *outgoing_edges_num,
                                ...
                                double *dangling_vec, size_t n)
{
    ...
    if (index < n)
    {
        ...
        for (int i = 0; i < num_edges; ++i)
        {
            ...
            double pr_eigenvector = 0.85 * pre_pagerank[inward_edge_index] / outgoing_edges_num[inward_edge_index];
